...
class GenshintestMod(loader.Module):
	"""Лольки геншина.
	Как использовать:
	.git@vladimirlut *лолька* текст
	Пример:
	.git@vladimirlut diona го бухать"""
	strings = {
		"name": "Genshin"
	}
	...
	Записывающая Цици: qiqiq"""
		...
		font = ImageFont.truetype(BytesIO(get(url+"boldd.ttf").content), 60)
